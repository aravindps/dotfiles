...
#alias xcapemap='xcape -e "Control_R=Return;Control_L=Escape;Shift_R=BackSpace"'
alias xcapemap='xcape -e "Control_R=Return;Shift_R=BackSpace" && echo "dual mode Ctrl_R|Return and Shift_R|Backspace"'
